...
namespace Lottak.Application.IService
{
    ...
    public interface IEncryptionService : IApplicationService
    {
        ...
        /// <returns></returns>
        string SHA1(string plainText, bool enablePrivateKey = false);
        ...
        /// <returns></returns>
        string HMACSHA256Encrypt(string strInput, string key, Encoding encoding);
        ...
        /// <param name="key"> 密钥 </param>
        /// <returns></returns>
        string HMACSHA256Encrypt(string strInput, string key);
    }
}
